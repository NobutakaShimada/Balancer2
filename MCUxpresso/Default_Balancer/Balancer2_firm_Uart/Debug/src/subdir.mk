...
src/%.o: ../src/%.c src/subdir.mk
	...
	arm-none-eabi-gcc -D__USE_CMSIS=Balancer2_lib -DDEBUG -D__CODE_RED -D__REDLIB__ -I"/Users/shimadalocal/src/Balancer2/MCUxpresso/Default_Balancer/Balancer2_firm_Uart/lib" -I"/Users/shimadalocal/src/Balancer2/MCUxpresso/Default_Balancer/Balancer2_firm_Uart/inc" -O1 -g -gdwarf-4 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fmacro-prefix-map="$(<D)/"= -mcpu=cortex-m3 -mthumb -D__REDLIB__ -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.o)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
