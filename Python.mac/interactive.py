...
def make_command(var_name: str, com: str) -> bytes:
    ...
    b_cmd = make_read_command_from_addr(addr, length, com)
...
if __name__ == '__main__':
    ...
    with open_beuato_device('/dev/BeuatoCtrl0', read_mode=BEUATO_MODE_ASCII) as dev:
        #fcntl.ioctl(dev, 0x40044200, struct.pack("I",DRIVER_DEBUG)) # debug dmesg
        set_beuato_debug(dev, DRIVER_DEBUG)
        set_beuato_read_mode(dev, BEUATO_MODE_ASCII)
